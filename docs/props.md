...
| intialFiles | `File[]` | | add these files to dropzone when it mounts, without any user interaction; see here for an [example of creating and uploading a file from a data URL](https://react-dropzone-uploader.js.org/docs/examples#initial-file-from-data-url) |
